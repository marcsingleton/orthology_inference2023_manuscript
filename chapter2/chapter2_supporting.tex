...
\centering
\caption{\textbf{Exchangeability matrices fit under different sampling strategies.}
Each panel is a mean of the exchangeability coefficients derived from the meta-alignments created by a single sampling strategy ($n = 25$). The prefix and suffix in the title of each panel indicate the maximum gap fraction and region type of the columns in the meta-alignments. For example, the columns in the ``50R\_disorder'' set of meta-alignments were fewer than 50\% gaps and sampled from the disorder subset.}
...
\centering
\caption{\textbf{Rate matrices fit under different sampling strategies.}
Each panel is a mean of the exchangeability coefficients derived from the meta-alignments created by a single sampling strategy ($n = 25$). See Fig.~\ref{sfig:CV_ematrix} for an explanation of the panel labels.}
...
\centering
\caption{\textbf{Correlations between mean exchangeability and rate matrices fit under different sampling strategies.}
