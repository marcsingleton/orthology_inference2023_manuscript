...
%    B. Definition and discussion of protein disorder
%        1. Structural heterogeneity, conformational ensembles, floppy
%        2. Major sequence characteristics and structural "modes"?
%    C. Disordered proteins are challenging to study with traditional methods
%    D. Genome sequencing and computational tools revealed disordered proteins are ubiquitous
...
%                c. Biologists are sometimes highly formulaic with their naming conventions, resulting in proteins like MAP kinase kinase kinase which phosphorylates MAP kinase kinase which phosphorylates MAP kinase which phosphorylates the MAP protein. [FOOTNOTE]
