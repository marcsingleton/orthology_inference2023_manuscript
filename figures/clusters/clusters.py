...
gs = plt.GridSpec(2, 2, width_ratios=(0.55, 0.45))
rectAC = (0.225, 0.2, 0.75, 0.7)
rectBD = (0.25, 0.2, 0.725, 0.7)
...
ax = subfig.add_axes(rectAC)
ax.set_xmargin(0.01)
ax.bar(xs, counts.values, width=0.6)
ax.set_xticks(xs, counts.index, rotation=60, fontsize=6)
