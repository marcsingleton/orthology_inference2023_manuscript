...
The alignments of representative sequences in orthologous groups 23D9 (A), 01E0 (B), and 07C3 (C) are shown before and after refinement. The refinement process removes long poorly supported segments at the termini. However, if residues are aligned to consensus columns before and after a long poorly segment, it remains in the alignment.}
